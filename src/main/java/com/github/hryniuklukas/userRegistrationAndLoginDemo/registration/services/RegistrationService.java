...
import com.github.hryniuklukas.userRegistrationAndLoginDemo.registration.email.services.ConfirmationMailService;
import com.github.hryniuklukas.userRegistrationAndLoginDemo.user.model.AppUser;
import com.github.hryniuklukas.userRegistrationAndLoginDemo.user.model.AppUserRole;
...
import com.github.hryniuklukas.userRegistrationAndLoginDemo.registration.email.services.EmailValidator;
...
public class RegistrationService {
  ...
  private final ConfirmationMailService mailService;
  ...
  public String register(RegistrationRequest request) {
    ...
    try {
      mailService.sendMail(request.email(), buildEmail(request.name(), link));
